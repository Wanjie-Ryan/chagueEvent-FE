...
const defaultSlides: Slide[] = [
  {
    type: "image",
    src: heroBanner,
    headline: "'STREET GOLD'",
    subtitle: "Spring '26 Collection",
    description: "Where style meets rhythm — discover the boldest streetwear drop of the season.",
  ...
  },
  {
    ...
    subtitle: "The Culture Collection",
    description: "Heavyweight hoodies, statement tees — outfit inspiration for the bold.",
    ctaPrimary: { label: "Shop", to: "/products" },
    ctaSecondary: { label: "Watch", to: null },
  },
  {
    type: "video",
    src: "/videos/seasonal-campaign.mp4",
    headline: "SEASONAL VIBES",
    subtitle: "Limited Edition Drop",
    description: "Exclusive pieces for the season. Fresh drops, bold aesthetics, timeless style.",
    ctaPrimary: { label: "Explore", to: "/products" },
